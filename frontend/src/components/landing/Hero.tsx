...
const Hero: React.FC = () => {
  ...
  return (
    <section
      className="flex flex-col items-center text-center pt-24 pb-20 px-4 max-w-4xl mx-auto fade-in"
    >
      {/* Centered Logo Mark */}
      <div
      ...
      >
        <div className="w-1.5 h-1.5 rounded-full bg-accent-green shadow-[0_0_8px_rgba(52,211,153,0.6)] pulse" />
