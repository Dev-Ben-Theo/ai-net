...
mod upgrade_tests {
    ...
    fn test_emergency_rollback_after_deadline() {
        ...
        env.ledger().set_sequence_number(current_seq + upgrade_manager::ROLLBACK_WINDOW_LEDGERS + 1);
    ...
    fn test_multiple_upgrades() {
        ...
        client.upgrade_contract(&hash_v1_1, &version_v1_1, &String::from_str(&env, "First upgrade"));
        ...
        client.upgrade_contract(&hash_v1_2, &version_v1_2, &String::from_str(&env, "Second upgrade"));
...
mod upgrade_integration_tests {
    ...
    fn test_full_upgrade_flow_integration() {
        ...
        let result = upgrade_mgr.propose_upgrade(
            &new_version,
            &new_hash,
            &description,
            &migration_plan,
        ...
        assert_eq!(restored_version.unwrap().version, String::from_str(&env, "1.0.0"));
    }
